...
"[project]/components/dashboard/voice-command.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function VoiceCommand() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        setResult(null);
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$243483__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["handleVoiceCommand"])(command);
        if (res.error) {
            toast({
                variant: "destructive",
...
//# sourceMappingURL=_c222851a._.js.map