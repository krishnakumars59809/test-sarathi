...
function App() {
    ...
    const processUserMessage = async (text)=>{
        setIsLoading(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$243483__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["handleVoiceCommand"])(text);
        let replyText = "";
        if (result.error) {
...
//# sourceMappingURL=_47d811ee._.js.map