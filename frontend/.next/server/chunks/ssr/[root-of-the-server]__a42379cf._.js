...
'use client';
;
const commandSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["z"].string().min(1, {
...
async function handleVoiceCommand(command) {
    ...
    try {
        ...
        return {
            error: 'Frontend API unreachable',
            details: e?.message
        };
    }
}
...
function App() {
    ...
    const processUserMessage = async (text)=>{
        setIsLoading(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleVoiceCommand"])(text);
        let replyText = "";
        if (result.error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a42379cf._.js.map